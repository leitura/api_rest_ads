...
exports.default = (function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var authToken, token, decoded, error_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                authToken = req.headers['authorization'];
                if (!(authToken != undefined)) return [3 /*break*/, 5];
                token = authToken.split(' ')[1];
                _a.label = 1;
            case 1:
                _a.trys.push([1, 3, , 4]);
                decoded = jsonwebtoken_1.default.verify(token, env_1.default.PASS);
                return [4 /*yield*/, database_1.users.exists({ username: decoded.username })];
            case 2:
                //@ts-ignore
                if (_a.sent()) {
                    next();
